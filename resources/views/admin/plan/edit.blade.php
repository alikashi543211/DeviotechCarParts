                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="subscription_type" class="form-control" name="subscription_type">
                                            ...
                                            <option value="1" {{$plan->subscription_type=="1"? 'selected' :''}}>Car Parts Advertisement</option>
                                            <option value="2" {{$plan->subscription_type=="2"? 'selected' :''}}>Scrapyard Car Advertisement</option>
                                            <option value="3" {{$plan->subscription_type=="3"? 'selected' :''}}>Ultimate</option>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-12">
                                                ...
                                                <input type="number" step=".02" id="amount" class="form-control @error('amount') is-invalid @enderror" name="amount" value="{{$plan->amount}}">
                                                @error('amount')
                                                <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
...
@section('js')
 <script type="text/javascript">
    var translations = <?php echo json_encode($plan->translations); ?>;
    mapTranslatedData(translations);

    function mapTranslatedData(translations)
    {
        console.log(translations);
        translations.forEach(function (value) {
            $(`input[name="${value.locale}[name]"]`).val(value.name);
            $(`textarea[name="${value.locale}[description]"]`).val(value.description);
        }); 
    }
 </script>
@endsection
