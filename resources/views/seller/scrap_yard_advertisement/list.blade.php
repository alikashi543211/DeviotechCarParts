...
<div class="content-header row">
    <div class="col-12">
        <h2>{{siteSetting()['scrap_yard_list_title'] ?? ''}}</h2>
    </div>
</div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown dropleft float-right">
                                                        <a type="button" class="fa fa-ellipsis-v" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="{{ route('seller.scrap.yard.advertisement.edit', $item->id)}}">
                                                                <div class="media">
                                                                    <div class="media-left" style="width: 25px;"><i class="fa fa-edit" aria-hidden="true"></i></div>
                                                                    <div class="media-body">Edit</div>
                                                                </div>
                                                            </a>
                                                            <a class="dropdown-item del_btn" data-href="{{ route('seller.scrap.yard.advertisement.delete', $item->id) }}">
                                                                <div class="media">
...
@section('js')
    ...
    <script>
        $(document).on("click",".adds_status",function(){
            ...
            location.href="{{ route('seller.scrap.yard.advertisement.change.status') }}?id="+id+"&status="+status;
        });
    </script>
