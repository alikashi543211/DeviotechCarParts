...
@section('title','Add Scrap Yard Advertisement')

@section('content')
<div class="content-header row">
    <div class="col-12">
        <h2>{{siteSetting()['scrap_yard_add_title'] ?? ''}}</h2>
    </div>
</div>
    ...
    <section>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('seller.scrap.yard.advertisement.save')}}" method="POST"  enctype="multipart/form-data">
                            @csrf
